...
function Hero() {
    return (
        <div className='  py-10 padding-x hero relative'>
            ...
            <p className='text-[14px] sm:text-[24px] text-[#FFF] text-center w-[95%] lg:w-[700px]'>Creating remarkable digital experiences for more than 4 years as a UX/UI Designer, Innovator, and Collaborator. Together, let's make something extraordinary! 🌟 Design Arena</p>
